...
/**
 * Each platform's own mark - messaging channels and data sources alike.
 *
...
/** The same lookup, named for what it draws when the thing is a data source. */
export const SourceIcon = ChannelIcon
